    ...
    <div style="background-color: #f3f4f6; padding: 40px;">
        <section style="max-width: 600px; margin: 0 auto; background-color: #ffffff; padding: 20px;">
            ...
            <main style="margin-top: 20px;">
                <p style="color: #4b5563; font-size: 1.5rem; font-weight: bold; margin-bottom: 10px;">Hi {{ $user }},</p>
        
                <p style="color: #6b7280; margin-top: 10px; line-height: 1.6;">Thank you for your payment. Your transaction with order ID <strong>{{ $reservedBooks->order_id }}</strong> has been successfully processed.</p>
                  
                <p style="color: #6b7280; margin-top: 10px;">Total amount paid: ${{ $peminjaman }}</p>
                
                <p style="color: #6b7280; margin-top: 20px;">Regards,<br>Libra</p>
            </main>
